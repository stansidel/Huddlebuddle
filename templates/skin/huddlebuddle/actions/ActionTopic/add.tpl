...
<form action="" method="POST" enctype="multipart/form-data">
	...
	<p><label for="topic_source_author">{$aLang.topic_source_author}:</label><br />
                                        <input type="text" id="topic_source_author" name="topic_source_author" value="{$_aRequest.topic_source_author}" class="input-wide" /><br />
                                <span class="note">{$aLang.topic_source_author_notice}</span></p>
	
	<p><label for="topic_source">{$aLang.topic_source}:</label><br />
                                        <input type="text" id="topic_source" name="topic_source" value="{$_aRequest.topic_source}" class="input-wide" /><br />
                                <span class="note">{$aLang.topic_source_notice}</span></p>

	
        {if $oUserCurrent->isAdministrator() || $oConfig->getValue("module.topic.user_block_comments")}
