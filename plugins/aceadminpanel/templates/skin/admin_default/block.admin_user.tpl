            ...
            <div class="profile-user">
                <div class="name">
                    ...
                    <div>
                        ...
                        <p class="nickname">ID: {$oUserProfile->getId()}</p>
                    ...
                    <div class="voting {if $oUserProfile->getRating()>=0}positive{else}negative{/if} {if !$oUserCurrent || $oUserProfile->getId()==$oUserCurrent->getId()}guest{/if} {if $oVote} voted {if $oUserProfile->getUserVoteDelta()>0}plus{elseif $oUserProfile->getUserVoteDelta()<0}minus{/if}{/if}">
